...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 14 2021 г., 23:39
...
CREATE TABLE `pacient` (
  ...
  `telephone` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `employment` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
...
ALTER TABLE `registration`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `code_pacient` (`code_pacient`,`code_doctor`),
...
ALTER TABLE `registration`
  ...
  ADD CONSTRAINT `registration_ibfk_2` FOREIGN KEY (`code_pacient`) REFERENCES `pacient` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `registration_ibfk_3` FOREIGN KEY (`number_dispanser`) REFERENCES `narko_dispancer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
